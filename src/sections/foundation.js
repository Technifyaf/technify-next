        ...
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            <Box sx={styles.content}>
              ...
              <Text as="p">
              We are building and training a community of young tech professionals. </Text>
              <Text as="p" sx={styles.specialText}>
                We want to see more tech learners, entrepreneurs and professionals in Southern Africa. As the global digital economy grows we want to make sure Africa is not left behind.
                 
             </Text>
             
              <a href = "https://technify-dot-org.vercel.app/"> Learn more</a> 
             <FaAngleRight />
            </Box>
          </Box>
