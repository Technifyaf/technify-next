...
const PRICE_MONTHLY_DATA = [
  {
    ...
    options: [
      {
        status: true,
        label: 'Facebook for buinesss',
      },
     
      {
        status: true,
        label: 'Whatsapp for businesss',
      },
      {
        status: true,
      ...
      {
        status: true,
        label: 'Post automation and tracking',
      },
      {
        status: true,
        label:
          'Targeted adversitising using pixels',
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        status: true,
        label:
          'Customer relationship managemnt software',
      },
     
      {
        status: true,
        label: 'Team and task management software',
      },
      {
        status: true,
        label: 'Intergrate your favourite software  ',
      },
      {
        status: true,
        label: 'Cloud storage backup and collaboration ',
      },
      {
        status: true,
        label: 'Online security and password management',
      },
    ],
  },
];
